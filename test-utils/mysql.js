...
exports.mysqlPool = _mysql.createPool(config);
var mysql = {
    query: function (text, params) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    exports.mysqlPool.getConnection(function (err, conn) {
                        if (err) {
                            return reject(err);
                        }
                        conn.query(text, params || [], function (error, results, fields) {
                            conn.release();
    ...
    end: function () { return exports.mysqlPool.end(); },
    config: config,
    mysql: _mysql
};
