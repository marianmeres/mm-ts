...
exports._queryMultipleStatements = (sqls, db, debug) => __awaiter(this, void 0, void 0, function* () {
    for (let sql of sqls) {
...
exports._initDb = (db, debug, withData = true) => __awaiter(this, void 0, void 0, function* () {
