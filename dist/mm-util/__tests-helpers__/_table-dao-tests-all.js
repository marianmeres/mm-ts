...
exports._sqlUtilTestsAll = {
    // single pk
    '`find` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao(db);
        const row = yield table.find(1);
        expect(row).toBeTruthy();
        expect(row.id).toEqual(1);
    }),
    '`findWhere` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao(db);
    ...
    '`save` (insert) works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao(db);
        let data = yield table.save({ label: 'kokos' });
        expect(data.id).toEqual(3);
        expect(data.label).toEqual('kokos');
    }),
    '`save` (update) works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao(db);
    ...
    // foo2, composite pk
    'foo2: `find` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
        const row = yield table.find({ id1: 1, id2: 2 });
        expect(row.label).toEqual('foo12');
    }),
    'foo2: `findWhere` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
        const row = yield table.fetchRow({ label: 'foo13' });
        expect(row.id2).toEqual(3);
    }),
    'foo2: `fetchAll` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
        const rows = yield table.fetchAll(null, { order_by: 'id2 DESC' });
        expect(rows).toBeTruthy();
        expect(rows[0].id2).toEqual(3); // desc
    }),
    'foo2: `fetchCount` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
        const count = yield table.fetchCount();
        expect(count).toEqual(2);
    }),
    'foo2: `save` (insert) works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
    ...
    'foo2: `save` (update) works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
        let data = yield table.save({
            id1: 1,
            id2: 2,
    ...
    'foo2: `delete` works': (db) => __awaiter(this, void 0, void 0, function* () {
        const table = dao2(db);
