...
export declare class WsMessage {
    ...
    expectsResponse: boolean;
    static readonly TYPE_JOIN_ROOM: string;
    static readonly TYPE_LEAVE_ROOM: string;
    static readonly TYPE_BROADCAST: string;
    static readonly TYPE_ECHO: string;
    static readonly TYPE_HEARTBEAT: string;
    static readonly TYPE_RECONNECT: string;
    static readonly TYPE_CONNECTION_ESTABLISHED: string;
    static readonly TYPE_JSONAPI: string;
    static readonly TYPE_JSONAPI_UPDATE: string;
    static readonly TYPE_JSONAPI_DELETE: string;
